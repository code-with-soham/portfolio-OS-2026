...
// ============================================
// Custom React terminal with boot sequence, command parsing,
// command history, and extensible command registry.
...
export default function TerminalApp() {
  ...
  const handleSubmit = (e) => {
    ...
    setOutput((prev) => [
      ...prev,
      { text: `soham@portfolio-os:~$ ${trimmed}`, type: 'command' },
    ]);
    ...
    <div className="terminal-app" onClick={handleTerminalClick}>
      ...
      {booted && (
        <form className="terminal-input-area" onSubmit={handleSubmit}>
          <span className="terminal-prompt">soham@portfolio-os:~$</span>
          <input
            ref={inputRef}
